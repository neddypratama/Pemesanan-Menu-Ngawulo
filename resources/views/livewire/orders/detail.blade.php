...
<div>
    <x-header title="View Transaction" separator progress-indicator />

    <div class="p-7 rounded-lg shadow-md">
    ...
    <div class="p-7 mt-4 rounded-lg shadow-md">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <p class="font-semibold">{{ $transaksi->user->address ?? '-' }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-7 mt-4 rounded-lg shadow-md">
        <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
            <div>
                <p class="mb-3">Note Transaction</p>
                <p class="font-semibold ">{{ $transaksi->keterangan ?? '-' }}</p>
            </div>
        </div>
    </div>
